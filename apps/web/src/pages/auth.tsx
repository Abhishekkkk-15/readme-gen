          ...
          <CardHeader>
            ...
            <CardDescription>
              {user
                ...
                : "Browsing as guest — some actions are limited."}
            </CardDescription>
          </CardHeader>
              ...
              <>
                <div className="text-muted-foreground text-sm">
                  ...
                  <p className="mt-1">
                    ...
                    {user.usage.generationsLimit > 0
                      ? ` / ${user.usage.generationsLimit}`
                      : " (unlimited)"}
                  </p>
                </div>
                <Separator />
      ...
      <motion.div
        ...
        <Card className="border-border/80 shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Sign in or create an account — demo only, no real auth.
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <form
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      id="reg-api"
                      type="password"
                      placeholder="Bring your own provider key"
                      {...regForm.register("apiKey")}
                    />
                  </div>
                  <button
                    type="submit"
  ...
  return (
    <div className="border-border rounded-lg border p-4">
      ...
      <p className="text-muted-foreground mt-1 text-xs">
        We will email a reset link (demo — shows toast only).
      </p>
